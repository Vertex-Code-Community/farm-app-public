const ukraineBrightMapConfig = {
    ...
    "bearing": 0,
    "pitch": 0,
    "sources": {"openmaptiles": {"type": "vector", "url": "pmtiles://https://YOUR-PMTILES-HOST-HERE/planet.pmtiles"}},
    "sprite": "https://tile.openstreetmap.org.ua/styles/osm-bright/sprite",
    "glyphs": "https://tile.openstreetmap.org.ua/fonts/{fontstack}/{range}.pbf",
    "layers": [{
        "id": "background",
        "type": "background",
        ...
        "paint": {"fill-color": "#fff", "fill-opacity": {"base": 1, "stops": [[0, 0.9], [10, 0.3]]}}
    }, {
        ...
        "source-layer": "park",
        "filter": ["==", "$type", "Polygon"],
        "paint": {"fill-color": "#d8e8c8", "fill-opacity": {"base": 1.8, "stops": [[9, 0.5], [12, 0.2]]}}
    }, {
        "id": "park-outline",
        "type": "line",
        "metadata": {"mapbox:group": "1444849388993.3071"},
        ...
        "filter": ["==", "class", "river"],
        "layout": {"line-cap": "round"},
        "paint": {"line-color": "#a0c8f0", "line-width": {"base": 1.2, "stops": [[10, 0.8], [20, 6]]}}
    }, {
        "id": "water-offset",
        "type": "fill",
        "metadata": {"mapbox:group": "1444849382550.77"},
        ...
        "paint": {
            ...
            "line-width": {"base": 1.2, "stops": [[7, 0], [8, 0.6], [9, 1.5], [20, 22]]}
        }
    }, {
        ...
        "paint": {
            ...
            "line-width": {"base": 1.2, "stops": [[5, 0], [6, 0.6], [7, 1.5], [20, 22]]}
        }
    }, {
        ...
        "paint": {
            "line-color": "#e9ac77",
            "line-width": {"base": 1.2, "stops": [[4, 0], [5, 0.4], [6, 0.6], [7, 1.5], [20, 22]]},
        ...
        "layout": {"line-cap": "round", "line-join": "round", "visibility": "visible"},
        "paint": {"line-color": "#fea", "line-width": {"base": 1.2, "stops": [[8.5, 0], [9, 0.5], [20, 18]]}}
    }, {
        "id": "highway-trunk",
        "type": "line",
        "metadata": {"mapbox:group": "1444849345966.4436"},
        ...
        "paint": {
            ...
            "line-width": {"base": 1.2, "stops": [[5, 0.4], [6, 0.6], [7, 1.5], [20, 26]]}
        }
    }, {
        ...
        "paint": {"line-color": "#f8f4f0", "line-width": {"base": 1.2, "stops": [[15, 1.2], [20, 18]]}}
    }, {
        "id": "bridge-path",
        "type": "line",
        "metadata": {"mapbox:group": "1444849334699.1902"},
        ...
        "filter": ["all", ["==", "brunnel", "bridge"], ["in", "class", "secondary", "tertiary"]],
        "layout": {"line-join": "round"},
        "paint": {"line-color": "#fea", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 20]]}}
    }, {
        ...
        "paint": {
            ...
            "line-width": {"base": 1, "stops": [[0, 0.6], [4, 1.4], [5, 2], [12, 8]]}
        }
    }, {
        "id": "boundary-water",
        "type": "line",
        ...
        "source-layer": "waterway",
        "minzoom": 13,
        "filter": ["all", ["==", "$type", "LineString"], ["has", "name"], ["!has", "name:uk"]],
        "layout": {
            "text-font": ["Open Sans Italic"],
            "text-size": 14,
            "text-field": "{name:uk} {name:nonlatin}",
            "text-max-width": 5,
        ...
        "filter": ["all", ["==", "$type", "LineString"], ["!has", "name:uk"]],
        "layout": {
            "text-font": ["Open Sans Italic"],
            "text-size": 14,
            "text-field": "{name:uk} {name:nonlatin}",
        ...
        "source": "openmaptiles",
        "source-layer": "water_name",
        "filter": ["all", ["==", "$type", "Point"], ["==", "class", "ocean"], ["!has", "name:uk"]],
        "layout": {
            "text-font": ["Open Sans Italic"],
            "text-size": 14,
            "text-field": "{name:uk}\n{name:nonlatin}",
        ...
        "source": "openmaptiles",
        "source-layer": "water_name",
        "filter": ["all", ["==", "$type", "Point"], ["!in", "class", "ocean"], ["!has", "name:uk"]],
        "layout": {
            "text-font": ["Open Sans Italic"],
        ...
        "paint": {"text-color": "#333", "text-halo-width": 1.2, "text-halo-color": "rgba(255,255,255,0.8)"},
        "filter": ["==", "$type", "Point"]
    }, {
        "id": "poi-level-3",
        "type": "symbol",
        ...
        "source-layer": "poi",
        "minzoom": 16,
        "filter": ["all", ["==", "$type", "Point"], [">=", "rank", 25], ["!has", "name:uk"]],
        "layout": {
            "text-padding": 2,
            "text-font": ["Open Sans Semibold"],
            "text-anchor": "top",
        ...
        "source-layer": "poi",
        "minzoom": 15,
        "filter": ["all", ["==", "$type", "Point"], ["all", ["<=", "rank", 24], [">=", "rank", 15]], ["!has", "name:uk"]],
        "layout": {
            "text-padding": 2,
            "text-font": ["Open Sans Semibold"],
            "text-anchor": "top",
        ...
        "source-layer": "poi",
        "minzoom": 14,
        "filter": ["all", ["==", "$type", "Point"], ["all", ["<=", "rank", 14], ["has", "name"]], ["!has", "name:uk"]],
        "layout": {
            "text-padding": 2,
            "text-font": ["Open Sans Semibold"],
            "text-anchor": "top",
        ...
        "minzoom": 15.5,
        "filter": ["all", ["==", "class", "path"], ["!has", "name:uk"]],
        "layout": {
        ...
        "paint": {"text-halo-color": "#f8f4f0", "text-color": "hsl(30, 23%, 62%)", "text-halo-width": 0.5}
    }, {
        ...
        "source-layer": "transportation_name",
        "minzoom": 15,
        "filter": ["all", ["==", "$type", "LineString"], ["in", "class", "minor", "service", "track"], ["!has", "name:uk"]],
        "layout": {
            "text-size": {"base": 1, "stops": [[13, 12], [14, 13]]},
            "text-font": ["Open Sans Regular"],
            "text-field": "{name:uk} {name:nonlatin}",
        ...
        "source-layer": "transportation_name",
        "minzoom": 12.2,
        "filter": ["all", ["in", "class", "primary", "secondary", "tertiary", "trunk"], ["!has", "name:uk"]],
        "layout": {
            "text-size": {"base": 1, "stops": [[13, 12], [14, 13]]},
            "text-font": ["Open Sans Regular"],
            "text-field": "{name:uk} {name:nonlatin}",
        ...
        "source": "openmaptiles",
        "source-layer": "place",
        "filter": ["all", ["!in", "class", "country", "city", "town", "village"], ["!has", "name:uk"]],
        "layout": {
        ...
        "paint": {"text-color": "#633", "text-halo-width": 1.2, "text-halo-color": "rgba(255,255,255,0.8)"}
    }, {
        "id": "place-other-en",
        "type": "symbol",
        "metadata": {"mapbox:group": "1444849242106.713"},
        ...
        "source": "openmaptiles",
        "source-layer": "place",
        "filter": ["all", ["==", "class", "village"], ["!has", "name:uk"]],
        "layout": {
            "text-font": ["Open Sans Regular"],
        ...
        "source-layer": "place",
        "minzoom": 7,
        "filter": ["all", ["==", "class", "town"], ["!has", "name:uk"]],
        "layout": {
            "text-font": ["Open Sans Regular"],
        ...
        "source-layer": "place",
        "minzoom": 7,
        "filter": ["all", ["!=", "capital", 2], ["==", "class", "city"], ["!has", "name:uk"]],
        "layout": {
            "text-font": ["Open Sans Semibold"],
        ...
        "source-layer": "place",
        "maxzoom": 1,
        "filter": ["all", ["==", "class", "continent"], ["!has", "name:uk"]],
        "layout": {
            "text-font": ["Open Sans Bold"],
            "text-field": "{name:uk}\n{name:nonlatin}",
            "text-size": 14,
