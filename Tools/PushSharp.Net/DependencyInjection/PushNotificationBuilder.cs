...
public sealed class PushNotificationBuilder
{
    ...
    /// <para>
    /// The consuming application implements <see cref="IDeviceRegistrationStore"/>
    /// using its own database and registers it here.
    /// </para>
    /// </summary>
    public PushNotificationBuilder AddDeviceStore<TStore>() where TStore : class, IDeviceRegistrationStore
    {
        Services.AddSingleton<IDeviceRegistrationStore, TStore>();
        return this;
    }
    ...
    /// </summary>
    public PushNotificationBuilder AddDeviceStore(IDeviceRegistrationStore instance)
    {
        ArgumentNullException.ThrowIfNull(instance);
        Services.AddSingleton(instance);
        return this;
